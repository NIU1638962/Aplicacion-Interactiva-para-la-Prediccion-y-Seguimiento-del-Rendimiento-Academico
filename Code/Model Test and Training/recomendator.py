...
def test_recomendator(
    ...
    # — Summary —
    summary = environment.pandas.DataFrame(
        [
            [
                'Best class already',
                f'{best_class_already}',
                f'{best_class_already/total*100:.1f}%',
            ],
            [
                'No change possible',
                f'{no_change_possible}',
                f'{no_change_possible/total*100:.1f}%',
            ],
            [
                'Improved',
                f'{improved}',
                f'{improved/total*100:.1f}%',
            ],
            [
                'Stayed the same',
                f'{same}',
            ...
            [
                'Standard deviation change in class rank with possible change',
                f'{environment.numpy.std(rank_changes):.2f}',
                '',
            ],
        ],
        columns=['Recommendator Results', 'Amount', 'Percentage'],
    )
